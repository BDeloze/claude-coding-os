...
const banner = [
  ...
  '- Token optimizer: Planner (high tier) names a tier per task (T0 haiku / T1 sonnet /',
  '  T2 opus, memory/model-routing.md); dispatch the coder with model: <tier>; escalate one',
  '  tier on two failures, never route down; Reviewer always high tier. T3 fable only for',
  '  the Planner on ambiguous requests and the Reviewer on security-heavy diffs.',
  '',
